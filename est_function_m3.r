  ...
  if(id_m %in% c(1,2,3)){
    ...
    if (modeling_method == "SVM") {
      ...
      svm_cube <- grid_latin_hypercube(
        cost(c(2^-5,2^5), trans=NULL),
        rbf_sigma(c(10^-4,0.5), trans= NULL),
